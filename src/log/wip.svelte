...
<p>
	...
	imgur announced it was <RainbowLink
		href="https://gizmodo.com/imgur-bans-nsfw-content-will-delete-old-posts-1850356455"
		>banning NSFW content</RainbowLink
	> lol. evidently this is due to some <RainbowLink
		href="https://www.aclu.org/news/lgbtq-rights/how-mastercards-new-policy-violates-sex-workers-rights"
		>new Mastercard regulations</RainbowLink
	> that are being enforced at the behest of an evangelical fash group <RainbowLink
		href="https://www.thedailybeast.com/inside-exodus-cry-the-shady-evangelical-group-with-trump-ties-waging-war-on-pornhub"
		>exodus cry</RainbowLink
	>, previously ihop (lol), that's also behind a ton of nefarious stuff globally. ive got a post in
	the works thinking through the imgur stuff, but it surprised me that the fact a bitch cant search
	for noncon porn anymore dates back specifically to the april 2021 new mastercard regulations. not
	even law! mastercard is now kinkshaming me directly! ohh noo, mastercard...my free access to kinky
	vintage porn...nooo dont take it away....id do Anything...yes, anything.....
</p>
<h5>
	amy de'ath, max fox, rahul rao - sex panics, capitalism, and the global right - <ChainLink
		href="https://www.eventbrite.co.uk/e/sex-panics-capitalism-and-the-global-right-an-evening-symposium-tickets-601430644247"
		target="blank"
		rel="noreferrer"
	/>
</h5>
<p>
	...
	was really invigorated by the talks and their helpfully very well flagged interlocutors. lots of discussion
	of fetishism and abstraction, two marx concepts which i really wish i had a better grasp on and am
	excited to read more on. on my reading list now are, among other things,
</p>
<h5>
	moishe postone - anti-semitism and national socialism - <ChainLink
		href="https://theanarchistlibrary.org/library/moishe-postone-anti-semitism-and-national-socialism.a4.pdf"
		target="blank"
		rel="noreferrer"
	/>
</h5>
...
<h5>
	endnotes - the logic of gender: on the separation of spheres and the process of abjection - <ChainLink
		href="https://endnotes.org.uk/articles/the-logic-of-gender"
		target="blank"
		rel="noreferrer"
	/>
</h5>
<p>
	...
	follow straight from capital" and "damn i will never be smart enough in marx tm to fully
	understand any of this." a girl can dream. this tries to answer the age old question "why/how is
	womens/reproductive labor made unwaged, and as a result, why/how does capitalism require and
	proliferate particular structures of sex and gender" with rigor and precision. probably the
	authors would take fault with those terms, as they introduce more rigorous and precise ones and
	reject the framing of the question in the old binaries, but those are like, the stakes of the
	argument. stay tuned for when im literate enough in marxist feminism to translate to the common
	tongue.
</p>
<h5>
	stuart hall et al - policing the crisis: mugging, the state, and law and order - <ChainLink
		href="https://archive.org/details/policingcrisismu0000hall"
		target="blank"
		rel="noreferrer"
	/>
</h5>
<p>
	...
	panics. not sure i have the bandwidth at the moment, this is like an actual book not an essay, but
	on the list for when i do.
</p>
<h4>techie stuff</h4>
<h5>
	raytracing in one weekend (<ChainLink
		href="https://raytracing.github.io/"
		target="blank"
		rel="noreferrer"
	/>) + real time rendering (<ChainLink
		href="https://www.realtimerendering.com/"
		target="blank"
		rel="noreferrer"
	/>)
</h5>
...
<h5>
	tech learning collective (<ChainLink
		href="https://techlearningcollective.com/"
		target="blank"
		rel="noreferrer"
	/>), over the wire (<ChainLink
...
<p>
	...
	generally, i say as part of that ecosystem) and almost all "learn to code" programs are focused on
	job-readiness. versus, it's sysadmin and more fundamental knowledge-of-how-to-tape-things-together
	skills that would be needed to un-cloud-ify and de-monopolize web hosting, and on a broader scale to
	dream up more promising ways of interacting and organizing digitally.
</p>
<p>
	...
	lil more if you want to do anything <s>dangerous</s> interesting w them.
</p>
<p>
	i generally enjoy becoming more fluent on the cli and comfortable messing around on servers, so i
	think i'll keep hacking away at over the wire challenges when i have the time in between all my
	other hobbies lol. there's also the tech learning collective, but aside from their free content
	they seem to mostly be on hiatus in terms of hosting events.
</p>
<p>
...
<h5>
	christopher chitty - sexual hegemony: statecraft, sodomy, and capital in the rise of the world
	system <ChainLink
		href="https://www.dukeupress.edu/sexual-hegemony"
		target="blank"
		rel="noreferrer"
	/>
</h5>
...
<h5>
	carolyn steedman - dust: the archive and cultural history <ChainLink
		href="https://www.rutgersuniversitypress.org/dust/9780813530475"
		target="blank"
		rel="noreferrer"
	/>
</h5>
...
<h5>
	jacques derrida - archive fever: a freudian impression <ChainLink
		href="https://press.uchicago.edu/ucp/books/book/chicago/A/bo27619045.html"
		target="blank"
		rel="noreferrer"
	/>
</h5>
...
<h5>
	yosef hayim yerushalmi - freud's moses: judaism terminable and interminable <ChainLink
		href="https://yalebooks.yale.edu/book/9780300057560/freuds-moses/"
		target="blank"
		rel="noreferrer"
	/>
</h5>
...
<h5>
	yosef hayim yerushalmi - zakhor: jewish history and jewish memory <ChainLink
		href="https://uwapress.uw.edu/book/9780295975191/zakhor/"
		target="blank"
		rel="noreferrer"
	/>
</h5>
...
<h5>
	carolyn steedman - strange dislocations: childhood and the idea of human interiority <ChainLink
		href="https://www.hup.harvard.edu/catalog.php?isbn=9780674839786"
		target="blank"
		rel="noreferrer"
	/>
</h5>
<p>
	...
	summarizing and reformulating the Victorian idea that the core of an individual’s psychic identity
